...
class AppColors {
  ...
  // gray background
  static const Color primarySecondaryBackground = Color.fromARGB(255, 170, 170, 170);
  // // grey backgound
  // static const Color primarySecondaryBackground =
  //     Color.fromARGB(255, 247, 247, 249);
  // main element color blue
  static const Color primaryElement = Color.fromARGB(255, 61, 61, 216);
  // main element color black
  static const Color primarySecondeElement = Color.fromARGB(255, 0, 0, 0);
