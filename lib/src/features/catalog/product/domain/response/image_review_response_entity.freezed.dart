...
part of 'image_review_response_entity.dart';
...
ImageReviewResponseEntity _$ImageReviewResponseEntityFromJson(
    Map<String, dynamic> json) {
  return _ImageReview.fromJson(json);
}

/// @nodoc
mixin _$ImageReviewResponseEntity {
  ...
  @JsonKey(ignore: true)
  $ImageReviewResponseEntityCopyWith<ImageReviewResponseEntity> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ImageReviewResponseEntityCopyWith<$Res> {
  factory $ImageReviewResponseEntityCopyWith(ImageReviewResponseEntity value,
          $Res Function(ImageReviewResponseEntity) then) =
      _$ImageReviewResponseEntityCopyWithImpl<$Res, ImageReviewResponseEntity>;
  @useResult
  $Res call({int iDReviewImage, int iDReview, String path});
}

/// @nodoc
class _$ImageReviewResponseEntityCopyWithImpl<$Res,
        $Val extends ImageReviewResponseEntity>
    implements $ImageReviewResponseEntityCopyWith<$Res> {
  _$ImageReviewResponseEntityCopyWithImpl(this._value, this._then);
...
class __$$ImageReviewImplCopyWithImpl<$Res>
    extends _$ImageReviewResponseEntityCopyWithImpl<$Res, _$ImageReviewImpl>
...
class _$ImageReviewImpl implements _ImageReview {
  ...
  @override
  String toString() {
    return 'ImageReviewResponseEntity(iDReviewImage: $iDReviewImage, iDReview: $iDReview, path: $path)';
  }
...
abstract class _ImageReview implements ImageReviewResponseEntity {
