...
part of 'brand_response_entity.dart';
...
BrandResponseEnity _$BrandResponseEnityFromJson(Map<String, dynamic> json) {
  return _BrandResponseEnity.fromJson(json);
}

/// @nodoc
mixin _$BrandResponseEnity {
  ...
  @JsonKey(ignore: true)
  $BrandResponseEnityCopyWith<BrandResponseEnity> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BrandResponseEnityCopyWith<$Res> {
  factory $BrandResponseEnityCopyWith(
          BrandResponseEnity value, $Res Function(BrandResponseEnity) then) =
      _$BrandResponseEnityCopyWithImpl<$Res, BrandResponseEnity>;
  @useResult
  $Res call(
...
/// @nodoc
class _$BrandResponseEnityCopyWithImpl<$Res, $Val extends BrandResponseEnity>
    implements $BrandResponseEnityCopyWith<$Res> {
  _$BrandResponseEnityCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$BrandResponseEnityImplCopyWith<$Res>
    implements $BrandResponseEnityCopyWith<$Res> {
  factory _$$BrandResponseEnityImplCopyWith(_$BrandResponseEnityImpl value,
          $Res Function(_$BrandResponseEnityImpl) then) =
      __$$BrandResponseEnityImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'IDBrand') int idBrand,
...
/// @nodoc
class __$$BrandResponseEnityImplCopyWithImpl<$Res>
    extends _$BrandResponseEnityCopyWithImpl<$Res, _$BrandResponseEnityImpl>
    implements _$$BrandResponseEnityImplCopyWith<$Res> {
  __$$BrandResponseEnityImplCopyWithImpl(_$BrandResponseEnityImpl _value,
      $Res Function(_$BrandResponseEnityImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$BrandResponseEnityImpl(
      idBrand: null == idBrand
          ? _value.idBrand
          : idBrand // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$BrandResponseEnityImpl implements _BrandResponseEnity {
  _$BrandResponseEnityImpl(
  ...
  factory _$BrandResponseEnityImpl.fromJson(Map<String, dynamic> json) =>
      _$$BrandResponseEnityImplFromJson(json);
  ...
  @override
  String toString() {
    return 'BrandResponseEnity(idBrand: $idBrand, nameBrand: $nameBrand, idCollection: $idCollection, country: $country, createdOn: $createdOn, isDeleted: $isDeleted, totalProduct: $totalProduct, totalPurchaseQuantity: $totalPurchaseQuantity)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$BrandResponseEnityImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BrandResponseEnityImplCopyWith<_$BrandResponseEnityImpl> get copyWith =>
      __$$BrandResponseEnityImplCopyWithImpl<_$BrandResponseEnityImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BrandResponseEnityImplToJson(
      this,
    );
  }
}

abstract class _BrandResponseEnity implements BrandResponseEnity {
  factory _BrandResponseEnity(
      ...
      @JsonKey(name: 'TotalPurchaseQuantity')
      final int? totalPurchaseQuantity}) = _$BrandResponseEnityImpl;

  factory _BrandResponseEnity.fromJson(Map<String, dynamic> json) =
      _$BrandResponseEnityImpl.fromJson;
