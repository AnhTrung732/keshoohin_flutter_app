...
_$ProductImpl _$$ProductImplFromJson(Map<String, dynamic> json) =>
    _$ProductImpl(
      ...
      brand: json['Brand'] == null
          ? null
          : BrandResponseEnity.fromJson(json['Brand'] as Map<String, dynamic>),
      images: (json['Images'] as List<dynamic>?)
          ?.map((e) =>
              ImageProductResponseEntity.fromJson(e as Map<String, dynamic>))
          .toList(),
      rating: json['Rating'],
      reviews: (json['Reviews'] as List<dynamic>?)
          ?.map((e) => ReviewResponseEntity.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
