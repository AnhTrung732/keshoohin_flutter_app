...
abstract class $BrandResponseModelCopyWith<$Res> {
  factory $BrandResponseModelCopyWith(
          BrandResponseModel value, $Res Function(BrandResponseModel) then) =
...
abstract class _$$BrandResponseModelImplCopyWith<$Res>
    implements $BrandResponseModelCopyWith<$Res> {
  factory _$$BrandResponseModelImplCopyWith(_$BrandResponseModelImpl value,
...
class __$$BrandResponseModelImplCopyWithImpl<$Res>
  ...
  __$$BrandResponseModelImplCopyWithImpl(_$BrandResponseModelImpl _value,
  ...
  $Res call({
    ...
    return _then(_$BrandResponseModelImpl(
      idBrand: null == idBrand
          ? _value.idBrand
          : idBrand // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$BrandResponseModelImpl extends _BrandResponseModel {
  ...
  @override
  String toString() {
    return 'BrandResponseModel(idBrand: $idBrand, nameBrand: $nameBrand, idCollection: $idCollection, country: $country, createdOn: $createdOn, isDeleted: $isDeleted, totalProduct: $totalProduct, totalPurchaseQuantity: $totalPurchaseQuantity)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$BrandResponseModelImplToJson(
      this,
    );
  }
}

abstract class _BrandResponseModel extends BrandResponseModel {
  factory _BrandResponseModel(
      ...
      @JsonKey(name: 'TotalPurchaseQuantity')
      final int? totalPurchaseQuantity}) = _$BrandResponseModelImpl;
  _BrandResponseModel._() : super._();
