...
class _$CartImpl implements _Cart {
  ...
  @override
  String toString() {
    return 'Cart(count: $count, total: $total, cartProducts: $cartProducts, selectedProductInCart: $selectedProductInCart, selectedCoupon: $selectedCoupon, userDetail: $userDetail)';
  }
