...
String _$homeImageSliderHash() => r'd587fe3ca2d6467e5dd45357f830a0552697fb5a';

/// See also [HomeImageSlider].
@ProviderFor(HomeImageSlider)
final homeImageSliderProvider =
    AsyncNotifierProvider<HomeImageSlider, List<ImageSlider>>.internal(
  HomeImageSlider.new,
...
typedef _$HomeImageSlider = AsyncNotifier<List<ImageSlider>>;
